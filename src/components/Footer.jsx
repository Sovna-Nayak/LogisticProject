          ...
          <div>
            ...
            <div className="space-y-4 text-slate-300">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <div>+91-8240742313</div>
                  <div>+91-9040170727</div>
                </div>
              </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-700">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-slate-400 text-sm text-center">
              © 2024 First Track Solution Technologies. All rights reserved.
            </p>
          </div>
        </div>
...
//     <footer
//       id="contact"
//       className="relative z-10 bg-slate-900 text-white scroll-mt-20"
//     >
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
//         <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
//           {/* Company Info */}
...
//                   key={i}
//                   href="#"
//                   className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-emerald-500 transition-colors"
//                 >
