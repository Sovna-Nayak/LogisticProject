        ...
        <div className="grid grid-cols-1 md:grid-cols-2 bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-10">
            <form className="space-y-8">
              ...
              {boxes.map((_, index) => (
                <div
                  key={index}
                  className="relative bg-slate-100 rounded-lg p-4 grid grid-cols-2 md:grid-cols-6 gap-3"
                >
                  {boxes.length > 1 && (
                    <button
                      type="button"
          ...
          <div className="hidden md:block relative">
            <div
              className="
                h-full min-h-[650px]
                bg-[url('/images/pricing-side.jpg')]
                bg-no-repeat bg-center bg-contain
              "
            />

            {/* <div className="absolute bottom-8 left-8 bg-black/40 text-white p-6 rounded-xl">
              <h3 className="text-2xl font-bold">Fast & Secure Shipping</h3>
              <p className="text-sm mt-2">
                Compare courier prices instantly
              </p>
            </div> */}
          </div>
