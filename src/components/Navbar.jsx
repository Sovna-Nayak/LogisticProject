...
//             <Link
//               to="/login"
//               className="bg-emerald-500 text-white px-4 py-2 rounded-md text-sm font-semibold hover:bg-emerald-600 transition"
//             >
//               LOGIN
//             </Link>
//           </div>
...
//                 href={link.href}
//                 onClick={() => setIsMobileMenuOpen(false)}
//                 className="block text-white text-sm font-medium py-2 hover:text-emerald-400 transition-colors"
//               >
//                 {link.name}
//               </a>
//             ))}
...
//               to="/login"
//               onClick={() => setIsMobileMenuOpen(false)}
//               className="block bg-emerald-500 text-center py-2 rounded-md font-semibold text-white hover:bg-emerald-600 transition"
//             >
//               LOGIN
//             </Link>
//           </div>
